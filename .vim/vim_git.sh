...
git submodule add git://github.com/markabe/bufexplorer.git .vim/bundle/bufexplorer
...
git submodule add git://github.com/tpope/vim-repeat.git .vim/bundle/vim-repeat
...
git submodule add git://github.com/motemen/git-vim.git .vim/bundle/git-vim
